        ...
        <div className="dasboardContainer">
          ...
          <div className="dashboard-body">
            <div className="votes-body">
              ...
              <div className="active-votes">
                ...
                <div>
                  ...
                  <span>
                    Click to check history of all created or participated votes
                  </span>
                </div>
              </div>
            </div>
            <div className="create-poll">
              <div> 
                <MdHowToVote /> <span>Create a poll </span></div> <IoIosArrowForward className="arrowFW"   /> 
            </div>
            <div className="view-report">
              <div>
                 <TbReportSearch /><span> Closed votes and Reports </span> </div> <IoIosArrowForward className="arrowFW"/>
            </div>
          </div>
        </div>
      </>
